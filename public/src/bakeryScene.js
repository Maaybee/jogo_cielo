...
export class BakeryScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image("bgBaker", "public/assets/backgrounds/bgBakery.png");
    ...
    this.load.image("angryBaker", "public/assets/characters/angryBaker.png");
    this.load.image("neutralBaker", "public/assets/characters/neutralBaker.png");
  ...
  // Cor da barra com base na satisfação
  ...
  // Caixa de diálogo e textos principais
  createDialogBox() {
...
    };
  ...
  handleOptionSelected(option) {
    ...
    this.oswaldoSprite
      .setTexture(option.isCorrect ? "baker" : "angryBaker")
      .setScale(0.4);
