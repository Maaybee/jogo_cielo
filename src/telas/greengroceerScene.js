...
export class GreengrocerScene extends Phaser.Scene {
  constructor() {
    super({ key: SCENES.GREENGROCER }); // Define a chave da cena
  ...
  preload() {
    ...
    this.load.audio("greengroceryMusic", "assets/sounds/greengrocerMusic.mp3");
  ...
  create() {
    ...
    this.julieSprite = this.add
      .image(250, 520, "greengrocer")
      .setScale(0.4);
    ...
    this.add
      .text(
        ...
        isSuccess
          ...
          : "Infelizmente a cliente não aceitou a proposta.",
        {
          fontSize: "18px",
          color: "#ffffff",
          fontFamily: "Arial",
